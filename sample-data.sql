-- Sample Data for FundsIndia RM Copilot
-- Run this in your Supabase SQL Editor to populate your existing tables
...
-- Insert portfolios for Rahul Sharma
...
-- Insert portfolios for Priya Mehta
INSERT INTO portfolios (client_id, fund_name, category, invested_amount, current_value, sip_amount, sip_date)
...
-- Insert portfolios for Arjun Nair
INSERT INTO portfolios (client_id, fund_name, category, invested_amount, current_value, sip_amount, sip_date)
...
-- Insert portfolios for Sneha Iyer
INSERT INTO portfolios (client_id, fund_name, category, invested_amount, current_value, sip_amount, sip_date)
...
-- Insert portfolios for Vikram Patel
INSERT INTO portfolios (client_id, fund_name, category, invested_amount, current_value, sip_amount, sip_date)
...
-- Insert activities for Rahul Sharma
...
-- Insert activities for other clients
INSERT INTO activities (client_id, type, description)
...
UNION ALL
SELECT 'Portfolios inserted:', COUNT(*) FROM portfolios
UNION ALL
